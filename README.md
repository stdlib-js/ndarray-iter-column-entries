...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/ndarray-iter-column-entries/tags). For example,

```javascript
nditerColumnEntries = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-iter-column-entries@v0.2.0-umd/browser.js' )
```
